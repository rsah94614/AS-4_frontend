...
export default function DashboardCard({
    ...
    const change = formatMonthComparison(
        stat?.this_month ?? null,
        stat?.last_month ?? null
    );
    ...
    return (
        <div
            onClick={onClick}
            className={cn(
                "relative rounded-2xl p-5 overflow-hidden border border-border bg-card shadow-sm transition-all duration-200",
